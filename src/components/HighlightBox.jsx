  ...
  return (
    <section className="bg-black pb-20">
      <div className="flex flex-col justify-center items-center">
        <div>
          <h4 className="uppercase text-[12px] text-slate-400 pt-12 pb-2 tracking-[.15em]">
            Moviedatabase lets you...
          </h4>
          <br />
          <div className="flex justify-center">
            <ul className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-full max-w-4xl px-4">
              <li className="group flex items-center bg-slate-700 p-3 rounded h-28 hover:bg-green-600 cursor-pointer">
                <svg
                  className="h-16 text-slate-400 group-hover:text-slate-50"
              ...
              <li className="group flex items-center bg-slate-700 p-3 rounded h-28 hover:bg-orange-500 cursor-pointer">
                <svg
                  className="h-16 text-slate-400 group-hover:text-slate-50"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
              ...
              <li className="group flex items-center bg-slate-700 p-3 rounded h-28 hover:bg-sky-500 cursor-pointer">
                <svg
                  className="h-16 text-slate-400 group-hover:text-slate-50"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
